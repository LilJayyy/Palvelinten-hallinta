...
Virheilmoitus näytti hyvin, missä virhe oli. Olin erheellisesti lisännyt `tasks/main.yml` sisältöön `hosts` -rivin ja `tasks` -otsikon. Sekoitin playbookin roolin sisällöt keskenään, jotka kuuluivat `site.yml`:ään.
