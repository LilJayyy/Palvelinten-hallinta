...
En päässyt etenemään `site.yml` tiedoston muokkaamiseen, sillä `hosts.ini` -tiedostossa oli vanhemmat tiedot, jossa se yritti kirjautua liljasha@localhost-ina, jolla olin testaillut aiemmin tunnin aikana.
